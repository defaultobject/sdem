...
def mongo_db_to_file_storage(project_dir: str, basedir: str, _id: int, overwrite: bool = False):
...
def file_storage_to_mongo_db(project_dir: str, collection, basedir: str, _id: int, insert_id: int, overwrite: bool = True, error_entry=False):
    """
