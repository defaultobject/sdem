...
def delete_id(folder_path, _id):
    if settings.verbose_flag:
        print('DELETING ID: ', _id)

    util.remove_dir_if_exists(folder_path)
...
def prune_experiments(experiment_config, run_config):
    """
...
def prune_and_fix_experiment_ids(experiment_config, run_config):
    prune_experiments(experiment_config, run_config)
